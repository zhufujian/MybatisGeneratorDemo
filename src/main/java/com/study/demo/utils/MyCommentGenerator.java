...
public class MyCommentGenerator implements CommentGenerator{
    ...
    */
	...
	public void addJavaFileComment(CompilationUnit compilationUnit) {
   	...
   	compilationUnit.addFileCommentLine("*@Company");
   	compilationUnit.addFileCommentLine("* ");
   	compilationUnit.addFileCommentLine("*@Description: ");
   	compilationUnit.addFileCommentLine("*@ClassName: "+compilationUnit.getType().getShortName()+".java");
   	compilationUnit.addFileCommentLine("*@author zhufj");
